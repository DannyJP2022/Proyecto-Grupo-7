 ...
 * @author Allison
 */
public class ventaFinalGrafica extends javax.swing.JFrame {

    /**
     * Creates new form ventaFinalGrafica
     */
    public ventaFinalGrafica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CATALOGO DE REPUESTOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventaFinalGrafica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventaFinalGrafica().setVisible(true);
            }
        });
    }
